package com.qwert2603.counter_integer_view;
...
public class CounterIntegerView extends LinearLayout {
    ...
    private void do_switch(int bi, int ei, String b, String e) {
        ...
        mOutTextView.postDelayed(new Runnable() {
            @Override
            public void run() {
                mOutTextView.setVisibility(GONE);
            }
        }, mOutTextView.animate().getDuration());
